...
!function (a) {
  var e = [],
    ...
    methods: {
      ...
      collectErrors: function collectErrors(e) {
        var t = {};
    ...
    validatorTypes: {
      ...
      ajax: {
        ...
        validate: function validate(e, t, i) {
  ...
  a.fn.jqBootstrapValidation = function (e) {
    return t.methods[e] ? t.methods[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != _typeof(e) && e ? (a.error("Method " + e + " does not exist on jQuery.jqBootstrapValidation"), null) : t.methods.init.apply(this, arguments);
